...
//Alyssa and Quinn's LED Hat code 
//code modified from adafruit sample code
//Hue to GRB code modified from akgraphics forum post on arduino's website
...
//  Send a theater pixel chase in...
  ...
  colorWipe(strip.Color(r, g, b), 15);
...
// rainbow(20);
 rainbowCycle(5);
 theaterChase(strip.Color(r, g, b), 80);
 //theaterChaseRainbow();
}
